    ...
    <div className="d-flex flex-column header flex-sm-row">
      ...
      <div className="d-flex flex-column align-items-end w-100">
        <nav className=" d-none d-sm-flex border-bottom flex-nowrap nav justify-content-between mt-1 p-0">
          <a className="text-link active pb-1" href="#">
            STARTSEITE
          </a>
          <a className="text-link text-danger text-nowrap pb-1" href="#">
            GARAGEN & GARAGENTOR KONFIGURATOR
          </a>
          <a className="text-link pb-1" href="#">
            INFO+
          </a>
          <a className="text-link pb-1" href="#">
            KONTAKT
